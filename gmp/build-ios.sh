...
create_framework() {
  ...
  local BUILD_PATH="./build/Clibgmp.xcframework"
  ...
  # Copy headers
  cp gmp.h $HEADER_PATH/
  cp gmpxx.h $HEADER_PATH/
  ...
  lipo -create -output ${SIMULATOR_PATH}/lib/libgmp.a \
	...
	xcodebuild -create-xcframework \
		-library ./lib/iphoneos/lib/libgmp.a -headers $HEADER_PATH \
		-library ${SIMULATOR_PATH}/lib/libgmp.a -headers $HEADER_PATH \
		-output $BUILD_PATH
